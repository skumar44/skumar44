...
public class Minesweeper extends JFrame implements MouseListener, ActionListener
{
 ...
 public int mines = 10;
 public JLabel txtMinesLeft;
 public JLabel txtTime;
 public JButton restart;
 public Square [][]buttons = new Square[rows][columns];
 public boolean started = false;
 public boolean finished = false;
 public int minesLeft = mines;
 public int fieldsLeft = rows * columns - minesLeft;
 ...
 */
 public void showZeros(Square theSquare){
  ...
  */
 public void checkForZeros(int x, int y){
